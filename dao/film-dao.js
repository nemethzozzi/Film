...
class FilmDAO {
	...
	async filmfeltoltes(cim, leiras, megjelenes, elozetesLink) {
		let id=2;
		let results = await db.query('INSERT INTO public.film (cim, leiras, megjelenes, elozetesLink) VALUES ($1, $2, $3, $4)', [cim, leiras, megjelenes, elozetesLink]).catch(console.log);
			return results;
	}
